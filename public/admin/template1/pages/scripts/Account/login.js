var Login = function () {
    ...
    return {
        ...
        init: function () {
            ...
            $.backstretch([
                    "/admin/template1/pages/img/login_bg/1.jpg",
                    "/admin/template1/pages/img/login_bg/2.jpg",
                    "/admin/template1/pages/img/login_bg/3.jpg",
                    "/admin/template1/pages/img/login_bg/4.jpg"
                ], {
                    fade: 1000,
                    duration: 8000
                }
